...
// WithAccountNo adds the accountNo to the get balance params
func (o *GetBalanceParams) WithAccountNo(accountNo string) *GetBalanceParams {
	o.SetAccountNo(accountNo)
	return o
}

// SetAccountNo adds the accountNo to the get balance params
func (o *GetBalanceParams) SetAccountNo(accountNo string) {
